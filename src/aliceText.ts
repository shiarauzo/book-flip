// Auto-generated from Project Gutenberg #11 (public domain). Full text of
// Lewis Carroll's Alice's Adventures in Wonderland — all twelve chapters.

export type Chapter = { roman: string; title: string; paragraphs: string[] };

export const ALICE_CHAPTERS: Chapter[] = [
  {
    "roman": "I",
